...
@state_var   = qw(date obsid simtsc simfa gratings ra dec roll dither);
@state_format= qw(14S   5N    6N      5N  5S       10S 9S  9S   4S );
@state_tol   = qw( 1    300    360   360  300      300 300 300  300);
